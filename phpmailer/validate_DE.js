    ...
    $('#contactform').on('submit', function (e) {
        ...
        $('#message-contact').slideUp(200, function () {
            ...
            .fail(function () {
                ...
                $('#message-contact')
                    .html('<div class="error_message">Ein Fehler ist beim Senden der Nachricht aufgetreten. Bitte versuchen Sie es später erneut.</div>')
                    .slideDown('slow');
            });
        });
    });
        ...
        $('#message-booking').slideUp(200, function () {
            ...
            .done(function (data) {
                handleResponse(
                    ...
                    'Wir haben Ihre Buchungsanfrage erhalten. Wir werden uns so schnell wie möglich bei Ihnen melden.'
                );
            })
            .fail(function () {
                $('#submit-booking').removeAttr('disabled');
                $('#message-booking')
                    .html('<div class="error_message">Ein Fehler ist beim Senden der Anfrage aufgetreten. Bitte versuchen Sie es später erneut.</div>')
                    .slideDown('slow');
            });
        });
    });
        ...
        $('#message-newsletter').slideUp(200, function () {
            ...
            .done(function (data) {
                handleResponse(
                    ...
                    'Vielen Dank, Ihre Anmeldung zum Newsletter wurde erfolgreich registriert.'
                );
            })
            .fail(function () {
                $('#submit-newsletter').removeAttr('disabled');
                $('#message-newsletter')
                    .html('<div class="error_message">Ein Fehler ist aufgetreten. Bitte versuchen Sie es in einem Moment erneut.</div>')
                    .slideDown('slow');
            });
        });
    });
