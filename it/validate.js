...
$(function () {
    ...
    function openSuccessModal(title, text) {
        ...
        if (els.textEl) els.textEl.textContent = text;
    ...
    function bindSuccessModalRedirect() {
        ...
        $(modalEl).off(".formsuccessredirect");

        $(modalEl).on("hidden.bs.modal.formsuccessredirect", function () {
            if (shouldRedirect) {
                goHome();
            }
        });
    ...
    function handleSuccessResponse(data, options) {
        ...
        if (parsed) {
            ...
            if (!openSuccessModal(title, text)) {
