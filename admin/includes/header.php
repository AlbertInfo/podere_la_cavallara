...
<head>
    ...
    <link rel="stylesheet" href="/admin/assets/css/interhome-import.css?v=20">
        ...
        <?php if ($currentAdmin): ?>
            <aside class="admin-sidebar" id="adminSidebar">
                <a class="sidebar-brand" href="<?= e(admin_url('index.php')) ?>">
                    <img class="sidebar-logo sidebar-logo-desktop" src="<?= e(admin_url('assets/img/logo_sticky.svg')) ?>" alt="Podere La Cavallara">
