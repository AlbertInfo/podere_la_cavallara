...
<head>
    ...
    <link rel="stylesheet" href="/admin/assets/css/admin-mobile.css?v=1">
...
<body data-current-path="<?= e($currentPath) ?>" data-mobile-nav-key="<?= e($mobileNavKey) ?>" data-admin-authenticated="<?= $currentAdmin ? '1' : '0' ?>">
