...
<div class="anagrafica-guest-card anagrafica-guest-card--primary">
    <div class="anagrafica-grid">
        ...
        <label>
            ...
            <input type="text" name="<?= e($prefix) ?>[document_expiry_date]" class="js-date" data-date-role="document-expiry" placeholder="Seleziona la data" autocomplete="off" required>
        </label>
        <label>
