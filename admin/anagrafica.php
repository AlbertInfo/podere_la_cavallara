        ...
        <div class="ross-day-panels">
            ...
            <div class="ross-day-export card-lite">
                ...
                <div class="ross-day-export__buttons">
                    <a class="btn btn-primary<?= $selectedDayFinalized ? '' : ' is-disabled' ?>" href="<?= $selectedDayFinalized ? e(admin_url('actions/generate-ross1000-day.php?month=' . rawurlencode($selectedMonth) . '&day=' . rawurlencode($selectedDay))) : '#' ?>"<?= $selectedDayFinalized ? '' : ' aria-disabled="true" tabindex="-1"' ?>>Esporta ROSS1000</a>
                    <a class="btn btn-light<?= $selectedDayFinalized ? '' : ' is-disabled' ?>" href="<?= $selectedDayFinalized ? e(admin_url('actions/generate-alloggiati-day.php?month=' . rawurlencode($selectedMonth) . '&day=' . rawurlencode($selectedDay))) : '#' ?>"<?= $selectedDayFinalized ? '' : ' aria-disabled="true" tabindex="-1"' ?>>Alloggiati (prossimo step)</a>
                </div>
