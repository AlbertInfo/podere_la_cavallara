...
$bookingModalRecord = [
    ...
    'booking_received_date' => anagrafica_form_date($bookingModalData['booking_received_date'] ?? $selectedDay),
    'arrival_date' => anagrafica_form_date($bookingModalData['arrival_date'] ?? $selectedDay),
...
$bookingModalLeader = $bookingModalGuests[0] ?? [];
$bookingModalAdditionalGuests = count($bookingModalGuests) > 1 ? array_slice($bookingModalGuests, 1) : [];
    ...
    <section class="card ross-month-card">
        <div class="ross-month-toolbar ross-surface">
            ...
            <div class="ross-month-toolbar__controls">
                ...
                <div class="ross-month-actions">
                    <div class="ross-month-actions__buttons">
                        <button class="btn btn-light btn-sm" type="button" data-dialog-open="rossMonthOverviewModal">Panoramica mese</button>
                        <button class="btn btn-primary btn-sm<?= $rossConfigReady ? '' : ' is-disabled' ?>" type="button" <?= $rossConfigReady ? 'data-dialog-open="rossMonthSettingsModal"' : 'disabled' ?>>Configura mese + esporta ROSS1000</button>
                    </div>
                    <small>Il mese viene già caricato quando cambi selettore o usi le frecce. Usa la configurazione mese per impostare intervalli aperti/chiusi e poi scaricare l'XML mensile.</small>
                </div>
            </div>
        </div>
...
<div class="anagrafica-modal" id="rossMonthOverviewModal" hidden>
            ...
            <?php else: ?>
                <div class="ross-record-list">
                    <?php foreach ($selectedBookings as $booking): ?>
                        ...
                        $payload = is_array($booking['modal_payload'] ?? null) ? $booking['modal_payload'] : anagrafica_build_booking_modal_payload($pdo, $booking);
                        ?>
    ...
    <div class="anagrafica-modal anagrafica-modal--booking<?= $bookingModalOpen ? ' is-open' : '' ?>" id="bookingSyncModal"<?= $bookingModalOpen ? '' : ' hidden' ?>>
        ...
        <div class="anagrafica-modal__dialog anagrafica-modal__dialog--wide booking-sync-dialog" role="dialog" aria-modal="true" aria-labelledby="bookingSyncModalTitle">
            <form method="post" action="<?= e(admin_url('actions/save-booking-anagrafica.php')) ?>" id="bookingSyncForm" novalidate>
                ...
                <div class="anagrafica-modal__header">
                    <div>
                        ...
                        <h3 id="bookingSyncModalTitle">Scheda anagrafica della prenotazione</h3>
                    </div>
                ...
                <div class="anagrafica-modal__body booking-sync-modal__body">
                    ...
                    <div class="anagrafica-section">
                        <div class="anagrafica-section__header">
                            <div>
                                ...
                                <p class="muted">La scheda della prenotazione usa gli stessi campi della nuova anagrafica e resta sincronizzata con la tabella prenotazioni.</p>
                            </div>
                        </div>
                        <div class="anagrafica-grid anagrafica-grid--compact booking-sync-grid">
                            ...
                            <label class="anagrafica-field<?= e($bookingModalFieldClass('booking_received_date')) ?>">
                                ...
                                <input type="text" name="booking_received_date" class="js-date booking-js-date" data-date-role="booking-received" value="<?= e((string) $bookingModalRecord['booking_received_date']) ?>" placeholder="Seleziona la data" autocomplete="off" required>
                            ...
                            <label class="anagrafica-field<?= e($bookingModalFieldClass('arrival_date')) ?>">
                                ...
                                <input type="text" name="arrival_date" class="js-date booking-js-date" data-date-role="arrival" value="<?= e((string) $bookingModalRecord['arrival_date']) ?>" placeholder="Seleziona la data" autocomplete="off" required>
                            ...
                            <label class="anagrafica-field<?= e($bookingModalFieldClass('departure_date')) ?>">
                                ...
                                <input type="text" name="departure_date" class="js-date booking-js-date" data-date-role="departure" value="<?= e((string) $bookingModalRecord['departure_date']) ?>" placeholder="Seleziona la data" autocomplete="off" required>
                    ...
                    <div class="anagrafica-section">
                        ...
                        <?php $fieldClass = $bookingModalFieldClass; $errorFor = $bookingModalErrorFor; $guestIndex = 0; $guestData = $bookingModalLeader; $isRepeaterGuest = false; $guestNumber = 1; require __DIR__ . '/includes/anagrafica_guest_fields.partial.php'; ?>
                    </div>
                    ...
                    <div class="anagrafica-section">
                        ...
                        <div class="anagrafica-repeater" id="bookingGuestRepeater">
                            <?php foreach ($bookingModalAdditionalGuests as $guestLoopIndex => $guestLoop): ?>
                                <?php $fieldClass = $bookingModalFieldClass; $errorFor = $bookingModalErrorFor; $guestIndex = $guestLoopIndex + 1; $guestData = $guestLoop; $isRepeaterGuest = true; $guestNumber = $guestLoopIndex + 2; require __DIR__ . '/includes/anagrafica_guest_fields.partial.php'; ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    ...
                    <template id="bookingGuestTemplate">
                        <div class="anagrafica-guest-card" data-guest-card data-guest-scope>
                            ...
                            <div class="anagrafica-grid">
                                ...
                                <label class="anagrafica-field"><span>Data di nascita</span><input type="text" class="js-date booking-js-date" data-date-role="birth" data-name="birth_date" placeholder="Seleziona la data" autocomplete="off" required></label>
                ...
                <div class="anagrafica-modal__actions">
                    ...
                    <?php endif; ?>
                    <button class="btn btn-primary" type="submit">Salva e sincronizza</button>
                </div>
            </form>
        </div>
    </div>
